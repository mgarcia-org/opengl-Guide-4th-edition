...
TARGETS = aaindex aargb accanti accpersp alpha3D \
		  ...
		  wrap colormatrix colortable convolution histogram minmax
...
GLUT = -lglut
LLDLIBS = $(GLUT) -lGLU -lGL -lXext -lX11 -lm #-lXmu 

all:  $(TARGETS) makebin

readImage.o:
	@echo " gcc -c readImage.c"
	 gcc -c readImage.c
...
$(TARGETS): readImage.o
	@echo "gcc obj" 
	echo $@.o
	gcc -c -I/usr/include -I$(TOP) $@.c  -o $@.o  # $<
	@echo "gcc bin" 
	echo $@.bin	
	gcc readImage.o $@.o $(LLDLIBS) -o $@.bin
